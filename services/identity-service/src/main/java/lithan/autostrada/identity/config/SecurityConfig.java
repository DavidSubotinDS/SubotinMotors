...
public class SecurityConfig {
  ...
  public SecurityFilterChain internalChain(HttpSecurity http) throws Exception {
    ...
    // Each endpoint verifies its distinct service credential or scoped JWT before work.
  }

  @Bean @org.springframework.core.annotation.Order(2)
  public SecurityFilterChain filterChain(HttpSecurity http, SessionValidity validity) throws Exception {
    http.addFilterAfter(new SessionValidityFilter(validity), org.springframework.security.web.context.SecurityContextHolderFilter.class);
