...
import lithan.autostrada.identity.repository.ProfilePictureRepository;
...
import lithan.autostrada.identity.validation.ImageUploadValidator;
import lithan.autostrada.identity.validation.ImageUploadValidator.ValidatedImage;
...
public class UserServiceImpl implements UserService {
  ...
  @Autowired
  private lithan.autostrada.identity.identity.CurrentIdentity currentIdentity;
